    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                <h2 class="mb-5">Our Apartments</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="hotel-room text-center">
                    <a href="#" class="d-block mb-0 thumbnail"><img src="<?php echo base_url('assets/front') ?>/images/img_1.jpg" alt="Image" class="img-fluid"></a>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="hotel-room text-center">
                    <a href="#" class="d-block mb-0 thumbnail"><img src="<?php echo base_url('assets/front') ?>/images/img_2.jpg" alt="Image" class="img-fluid"></a>
                    <div class="hotel-room-body">
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="hotel-room text-center">
                    <a href="#" class="d-block mb-0 thumbnail"><img src="<?php echo base_url('assets/front') ?>/images/img_3.jpg" alt="Image" class="img-fluid"></a>
                    <div class="hotel-room-body">
