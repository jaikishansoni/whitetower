    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <?php endif; ?>
                <?php if (!empty($images)) { ?>
                    <h4 class="sub-title"><?php echo lang('room_images'); ?></h4>
                    <div class="row no-gutters">
            ...
            <div class="col-md-5">
                ...
                <br />
                <form class="p-5 bg-white" method="get" action="<?php echo site_url('front/bookapartments/index') ?>" id="checkform">
                    ...
                    <div class="reservation">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="check_in_time"><?php echo lang('check_out_time'); ?></label>
