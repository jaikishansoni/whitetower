    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mx-auto text-center mb-5 section-heading">
                <h2 class="mb-5"><?php echo lang("booking_summary"); ?></h2>
            </div>
                ...
                <div class="panel-body">
                    <table class="table table-striped table-hover"  id="printbooking">
                        ...
                        <tr>
                            ...
                            <td><?php echo $order->check_in_time; ?></td>
                            <th><?php echo lang('check_out_time') ?></th>
                            <td><?php echo $order->check_out_time; ?></td>
                        </tr>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <div class="pull-right">
                                <button type="submit" id="print" class="btn btn-primary pill px-4 py-2"><?php echo lang('print') ?></button>
<!--                                <a href="<?php echo site_url('front/account/pdf/' . $order->id) ?>" class="btn btn-primary pill px-4 py-2"> <i class="fa fa-download"></i> <?php echo lang('download') ?></a>-->
                            </div>
                        </div>
                    </div>
                </div>
