    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            foreach ($room_types as $rt):
                ...
                $rt_image = get_room1_type_featured_image_medium($rt->id);
                $amenities = $this->homepage_model->get_amenities($rt->id);
                ?>
                <div class="col-md-6 col-lg-4 mb-5">
                    <form method="GET" action="<?php echo site_url('front/bookrooms/index') ?>">
                        ...
                        <div class="hotel-room text-center">
                            <a href="<?php echo site_url('rooms/' . $rt->slug) ?>" class="d-block mb-0 thumbnail">
                            ...
                            <div class="hotel-room-body">
                                ...
                                <strong class="price"><?php echo $this->setting->currency_symbol . " " . $rt->base_price . "/" . lang('night'); ?></strong>
                            </div>
