...
Class Homepage_model extends CI_Model {
    ...
    function get_room_feature_Image($id) {
    ...
    function get_room_no_feature_Image($id) {
        $this->db->where('room1_type_id', $id);
    ...
    function get_no_feature_Image($id) {
        $this->db->where('room_type_id', $id);
        $this->db->where('is_featured', 0);
        $result = $this->db->get('room_types_images');
        return $result->result();
    ...
    function get_room_types() {
        $this->db->order_by('id', 'RANDOM');
        return $this->db->get('room1_types', 4)->result();
    }

    function get_apartment_types() {
        $this->db->order_by('id', 'RANDOM');
        return $this->db->get('room_types', 6)->result();
    }

    function get_apartment_type($id) {
        $this->db->where('id', $id);
        return $this->db->get('room_types')->row();
    }

    function get_room1_type($id) {
        $this->db->where('id', $id);
        return $this->db->get('room1_types')->row();
    }
    ...
    function get_room1_types_all() {
        $this->db->order_by('title', 'ASC');
        return $this->db->get('room1_types')->result();
    }
