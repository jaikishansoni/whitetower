                        ...
                        <div id="tab-1"> 
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label><?php echo lang('short_description_arabic') ?></label>
                                            <?php
                                            $data = array('rows' => '3', 'name' => 'short_description_arabic', 'value' => set_value('short_description_arabic', @$short_description_arabic), 'class' => 'form-control ');
                                            echo form_textarea($data);
                                            ?>
                                        </div>	
                                    </div>		
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $data = array('name' => 'description', 'class' => 'ckeditor form-control', 'value' => set_value('description', @$description));
                                    echo form_textarea($data);
                                    ?>
                                </div>
                                <div class="form-group">
                                    <label for="content"><?php echo lang('description_arabic'); ?></label>
                                    <?php
                                    $data = array('name' => 'description_arabic', 'class' => 'ckeditor form-control', 'value' => set_value('description_arabic', @$description_arabic));
                                    echo form_textarea($data);
                                    ?>
                                </div>
                            </fieldset>
