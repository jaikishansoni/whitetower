...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo ($this->uri->segment(2) == 'room_bookings') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/room_bookings') ?>"><i class="fa fa-list-alt"></i> <span><?php echo lang('room_bookings'); ?></span></a></li>
...
<!--            <li class="<?php echo ($this->uri->segment(2) == 'menus') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/menus') ?>"><i class="fa fa-bars"></i> <span><?php echo lang('menus'); ?></span></a></li>-->
            ...
            <li class="treeview <?php echo($this->uri->segment(2) == 'room_types' || $this->uri->segment(2) == 'rooms' || $this->uri->segment(2) == 'services' || $this->uri->segment(2) == 'coupons' || $this->uri->segment(2) == 'price_manager' || $this->uri->segment(2) == 'floors' || $this->uri->segment(2) == 'amenities') ? 'active' : ''; ?>">
                <a href="#">
                    ...
                    <span><?php echo lang('hotel_apartment_configration') ?></span>
            ...
            <li class="treeview <?php echo($this->uri->segment(2) == 'room1_types' || $this->uri->segment(2) == 'rooms1' || $this->uri->segment(2) == 'services' || $this->uri->segment(2) == 'coupons' || $this->uri->segment(2) == 'price_manager' || $this->uri->segment(2) == 'floors' || $this->uri->segment(2) == 'amenities') ? 'active' : ''; ?>">
                <a href="#">
                    <i class="fa fa-cubes"></i>
                    <span><?php echo lang('hotel_room_configration') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php echo ($this->uri->segment(2) == 'room_types1') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/room1_types') ?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('room1_types'); ?></span></a></li>
                    <li class="<?php echo ($this->uri->segment(2) == 'rooms1') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/rooms1') ?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('rooms1'); ?></span></a></li>
                    <li class="<?php echo ($this->uri->segment(2) == 'price_manager_room') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/price_manager_room') ?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('price_manager'); ?></span></a></li>
<!--                    <li class="<?php echo ($this->uri->segment(2) == 'services') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/services') ?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('paid_services'); ?></span></a></li>
                    <li class="<?php echo ($this->uri->segment(2) == 'coupons') ? 'active' : '' ?>"><a href="<?php echo site_url('admin/coupons') ?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('coupon_management'); ?></span></a></li>
