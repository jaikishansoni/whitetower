...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo lang('room_bookings'); ?></li>
    </ol>
</section>
    ...
    <div class="row" style="padding:20px;">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a class="btn btn-success" href="<?php echo site_url('admin/room_bookings/add'); ?>"><i class="fa fa-plus"></i> <?php echo lang('add'); ?></a>
            </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('room_bookings'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form method="post">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <select name="room_type_id" class="form-control" onchange="this.form.submit();">
                                        <option value="">--<?php echo lang('filter_by_room1_type') ?>--</option>
...
<script type="text/javascript">
                                        ...
                                        $("#example1 tbody td").on('click', function () {
                                            ...
                                            if (id) {
                                                document.location.href = "<?php echo site_url('admin/room_bookings/booking/') ?>" + id;
                                            }
                                        });
