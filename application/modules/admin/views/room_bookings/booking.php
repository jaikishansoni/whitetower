...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/room_bookings') ?>"> <?php echo lang('room_bookings') ?> </a></li>
...
<section class="invoice">
    ...
    <div id="responsiveTabsDemo">
        <ul>
            ...
            <li><a href="#tab-3"> <?php echo lang('room1') ?></a></li>
        </ul>
        <div id="tab-1">
            ...
            <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                    <table width="90%">
                        ...
                        <tr>
                            <th><b><?php echo lang('check_in_time') ?> </b></th>
                            <th>:</th>
                            <td ><?php echo time_convert($booking->check_in_time); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th><b><?php echo lang('check_out_time') ?></b></th>
                            <th>:</th>
                            <td ><?php echo time_convert($booking->check_out_time); ?></td>
                        </tr>
                        <tr>
        ...
        <div id="tab-3">
            <form method="post" action="<?php echo site_url('admin/room_bookings/alotroom') ?>">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <select name="room1_id" class="form-control">
                                <option value="">--<?php echo lang('select_room') ?>--</option>
                                <?php foreach ($rooms as $room) { ?>
                                    <option value="<?php echo $room->id ?>" <?php echo (@$order_room->room_id == $room->id) ? 'selected="selected"' : ''; ?>><?php echo $room->room1_no; ?> - <?php echo $room->floor ?></option>
                                <?php } ?>
                            </select>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content ff">
            ...
            <!-- form start -->
            <form method="post" action="<?php echo site_url('admin/room_bookings/payment/') ?>" enctype="multipart/form-data" id="add_form">
                <input type="hidden" name="order_id" value="<?php echo $booking->id ?>" />
                <div class="box-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content ff">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="<?php echo site_url('admin/room_bookings/edit_payment/') ?>" enctype="multipart/form-data">
...
//$(this).closest("form").submit();	
                ...
                call_loader();
                $.ajax({
                    url: '<?php echo site_url('admin/room_bookings/edit_payment') ?>',
                    type: 'POST',
                    data: $(form).serialize(),
                    success: function (result) {
                        ...
                        {
                            //location.reload();
                            location.href = '<?php echo site_url('admin/room_bookings/booking/' . $booking->id . '/payment') ?>';
                            // $('#edit'+id).modal('hide');
                            //window.close(); 
                        }
                        else
            ...
            $("#booking_status").change(function (event) {
                ...
                call_loader();
                $.ajax({
                    url: '<?php echo site_url('admin/room_bookings/booking_status') ?>',
                    type: 'POST',
            ...
            $("#payment_status").change(function (event) {
                ...
                call_loader();
                $.ajax({
                    url: '<?php echo site_url('admin/room_bookings/payment_status') ?>',
                    type: 'POST',
                    data: {status: val, id:<?php echo $booking->id ?>},
                    success: function (result) {
                        //alert(result);return false;
