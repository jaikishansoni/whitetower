                    ...
                    <form method="post"  enctype="multipart/form-data" id="add_form" >	
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select name="room1_type_id" class="form-control">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="time" name="check_in_time" class="form-control" placeholder="<?php echo lang('check_in_time') ?>" autocomplete="off" />
                                </div>	
                                <div class="col-md-2">
                                    <label><?php echo lang('check_out_time') ?></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="time" name="check_out_time" class="form-control"  placeholder="<?php echo lang('check_out_time') ?>" autocomplete="off"/>
                                </div>		
                            </div>
                        </div>
...
<script>
    ...
    function check_availbility() {
        call_loader();
        $.ajax({
            url: '<?php echo site_url('admin/room_bookings/check_availability') ?>',
            type: 'POST',
    ...
    function get_order_data() {
        call_loader();
        $.ajax({
            url: '<?php echo site_url('admin/room_bookings/get_booking_data') ?>',
            type: 'POST',
            data: $('#add_form').serialize(),
            success: function (result) {
                //alert(result);return false;
