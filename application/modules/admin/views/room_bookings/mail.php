...
<table class="table" border="1" id="printbooking" width="100%">
    ...
    <tr>
        ...
        <th class="success"><?php echo lang('check_in_time') ?></th>
        <td class="table-active"><?php echo time_convert($order->check_in_time) ?></td>
        <th class="success"><?php echo lang('check_out') ?></th>
        <td class="table-active"><?php echo date_convert($order->check_out); ?></td>
        <th class="success"><?php echo lang('check_out_time') ?></th>
        <td class="table-active"><?php echo time_convert($order->check_out_time); ?></td>
    </tr>
    ...
    <tr>
        <th class="success"><?php echo lang('room1_type') ?></th>
        <td class="table-active"><?php echo $order->room1_type ?></td>
