        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <form method="post" action="<?php echo site_url('admin/room1_types/form/' . $id); ?>" enctype="multipart/form-data">	
...
<?php } ?>
                                                        ...
                                                        $('#higher_occupancy').on('keypress, keyup, blur', function (event) {
                                                            ...
                                                            if (ho) {
                                                                if (ho < bo) {
                                                                    ...
                                                                    alert('Higher Occupancy Must Greather Then Or Equal To Base Price');
                                                                    return false;
                                                                }
                                                            }
                                                        });
                                                        $('#extra_beds').on('keypress, keyup, blur', function (event) {
                                                            ...
                                                            if (sb > 0) {
                                                                if (eb > sb) {
                                                                    //$('#higher_occupancy').focus();
                                                                    alert('Extra Bed Must Less Then Higher Occupancy  And Greter Then Base Occupancy');
                                                                    return false;
                                                                }
                                                            }
                                                        });
                                                        ...
                                                        $(document).on("click", ".remove_fieldedit", function (e) { //user click on remove text
                                                            ...
                                                            if (id) {
                                                                if (window.confirm("Are you sure remove this image ?")) {
                                                                    call_loader();
                                                                    $.ajax({
                                                                        url: '<?php echo site_url('admin/room1_types/updateimg') ?>',
                                                                        type: 'POST',
                                                                        data: {id: id},
...
<?php } ?>
                                                    ...
                                                    $(document).on("change", ".imgchange", function (e) { //user click on remove text
                                                        ...
                                                        if (id) {
                                                            ...
                                                            call_loader();
                                                            $.ajax({
                                                                url: '<?php echo site_url('admin/room1_types/edit_image'); ?>/' + id,
                                                                type: 'POST',
                                                                xhr: function () {
                                                    ...
                                                    $(document).ready(function () {
                                                        $('.featured').on('ifChecked', function (event) {
                                                            ...
                                                            if (id) {
                                                                call_loader();
                                                                $.ajax({
                                                                    url: '<?php echo site_url('admin/room1_types/featured') ?>',
                                                                    type: 'POST',
