                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="other_phone" value="<?php echo set_value('other_phone', @$setting->other_phone) ?>" class="form-control" />
                                        </div>	
                                    </div>		
                                </div>
                                <div class="form-group">
...
foreach ($taxes as $new) {
    $sel = "";
    if (in_array($new->id, json_decode(@$setting->taxes)))
        $sel = 'selected="selected"';
