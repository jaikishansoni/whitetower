...
class Pages extends Admin_Controller {
    ...
    function form($id = false) {
        ...
        if ($id) {
            ...
            $data['short_description'] = $page->short_description;
            $data['short_description_arabic'] = $page->short_description_arabic;
            $data['description'] = $page->description;
            $data['description_arabic'] = $page->description_arabic;
        ...
        if ($this->form_validation->run() == false) {
            ...
            $save['short_description_arabic'] = $this->input->post('short_description_arabic');
            $save['description'] = $this->input->post('description');
            $save['description_arabic'] = $this->input->post('description_arabic');
