...
class Expenses extends Admin_Controller {
    ...
    function printpdf($id) {
        $data['page_title'] = lang('expenses');
        $data['expenseData'] = $this->expenses_model->get_expense($id);
        
        $this->render_admin('expanses/printpdf', $data);
    }
    ...
    private function set_upload_options() {  //  upload an image and document options
        $config = array();
